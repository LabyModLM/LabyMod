...
public class GuiCustomizeSkin extends GuiScreen
{
    ...
    public void LabyMod()
    {
        ...
        {
            this.buttonList.add(this.parentScreenButton = new GuiButton(1, this.width / 2 + 40, this.height / 2 - 58, 80, 20, ""));
        ...
        this.buttonList.add(this.titleButton = new GuiButton(11, 2, 2, 95, 20, ""));
    ...
    {
        if (this.parentScreenButton != null)
        {
            this.parentScreenButton.displayString = this.getStatus("Hat", EnumPlayerModelParts.HAT);
        ...
        {
            this.titleButton.displayString = "Cosmetics";

            if (this.advanced)
            {
                this.titleButton.yPosition = this.height / 2 + 55;
                this.titleButton.xPosition = this.width / 2 - 45;
            }
            else
            {
                this.titleButton.yPosition = this.height / 2 + 75;
                this.titleButton.xPosition = this.width / 2 - 100;
            }
        }
